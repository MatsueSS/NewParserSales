...
Interface::Interface(std::string str, std::unique_ptr<Recommendations> nptr, std::unique_ptr<Matcher> ptr) : ptr(std::make_unique<BotTelegram>(std::move(str), std::move(nptr), std::move(ptr))) 
{}
